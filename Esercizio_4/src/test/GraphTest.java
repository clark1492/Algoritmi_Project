...
/**
 * Test suite for DirectedGraph and UndirectedGraph data structure
 */
public class GraphTest {
  ...
  public void initialize() {
    ...
    undirectedGraph.addEdge('A', 'B', 8.0);
    undirectedGraph.addEdge('A', 'E', 6.0);
    undirectedGraph.addEdge('B', 'C', 1.0);
    undirectedGraph.addEdge('B', 'D', 1.0);
    undirectedGraph.addEdge('C', 'D', 3.0);
    undirectedGraph.addEdge('C', 'E', 2.0);
    undirectedGraph.addEdge('D', 'E', 7.0);
  ...
  public void removeNotInListEdge() {
    ...
    assertFalse(undirectedGraph.removeEdge('A', 'D'));
  ...
  public void edgeSize() {
    ...
    assertEquals(8, undirectedGraph.getEdgeSize());
  }
  ...
  public void getEdges() {
    ...
    undirectedEdges.add(new Edge<>('A', 'B', 8.0));
    undirectedEdges.add(new Edge<>('A', 'C', 5.0));
    undirectedEdges.add(new Edge<>('A', 'E', 6.0));
    
    undirectedEdges.add(new Edge<>('B', 'A', 8.0));
    undirectedEdges.add(new Edge<>('B', 'C', 1.0));
    undirectedEdges.add(new Edge<>('B', 'D', 1.0));
    
    undirectedEdges.add(new Edge<>('C', 'A', 5.0));
    undirectedEdges.add(new Edge<>('C', 'B', 1.0));
    undirectedEdges.add(new Edge<>('C', 'D', 3.0));
    undirectedEdges.add(new Edge<>('C', 'E', 2.0));

    undirectedEdges.add(new Edge<>('D', 'B', 1.0));
    undirectedEdges.add(new Edge<>('D', 'C', 3.0));
    undirectedEdges.add(new Edge<>('D', 'E', 7.0));

    undirectedEdges.add(new Edge<>('E', 'A', 6.0));
    undirectedEdges.add(new Edge<>('E', 'C', 2.0));
    undirectedEdges.add(new Edge<>('E', 'D', 7.0));
  ...
  public void graphWeight_kruskalAlgorithm() throws GraphException, UnionFindException {
    ...
    assertEquals(33.0, undirectedGraph.getGraphWeight(), 0.0);
    ...
    assertEquals(9.0, minimumSpanninTree.getGraphWeight(), 0.0);
  }
}