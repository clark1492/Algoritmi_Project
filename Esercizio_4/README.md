...
2) java graphusagejava/KruskalAlgorithmUsage "../../italian_dist_graph.csv"
...
* **MakeSet** - crea semplicemente un albero con un solo nodo
...
* **Union**   - fa sì che la radice di un albero puntialla radice di dell'altro albero. Si sfrutta l'euristica dell'unione per rango - l'idea che la radice dell'albero con meno nodi punti alla radice dell'albero che ne ha dipiù
